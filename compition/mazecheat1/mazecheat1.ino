...
void done() //now the bot scan for everything and standing in the final rectabgular box
{
  digitalWrite(leftMotor1, LOW);
    digitalWrite(leftMotor2, LOW);
    digitalWrite(rightMotor1, LOW);
    digitalWrite(rightMotor2, LOW);
 delay(10000);
  replay();//now it go to the function which takes the stored variable and runs in the shortest path 
}
